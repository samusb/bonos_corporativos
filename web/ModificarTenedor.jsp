<%-- 
    Document   : ModificarTenedor
    Created on : 04-28-2021, 04:21:02 PM
    Author     : aprivera
--%>
            ...
            <div class="col-md-10 col-md-offset-1 m-auto">
                ...
                <div class="row">
                    <form action="CertCustodiaSV" method="post">  
                        <input type="hidden" id="opcion"  value ="7" name="opcion" />
                         <%
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputNombre" name="inputNombre" value="<%=c.getCTCNOM()%>" >
                                </div>
                            </div>                
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputIden" name="inputIden"  value="<%=c.getCTCIDN()%>" >
                                </div>
                            </div>
                            <div class="col-sm-4">

                                <div class="form-group">
                                    <label for="inputNoBono">No. de Cert</label>
...
<!--                        <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" min="0"  id="inputAio" step="1" pattern="\d+" value="" type="number" name="inputACC" />
                            </div>
                        </div>-->
